...
static const char *strDNSSeed[][2] = {
    {"telenode1.telecoin.net", "telenode1.telecoin.net"},
    {"telenode2.telecoin.net", "telenode2.telecoin.net"},
};


// hidden service seeds
static const char *strMainNetOnionSeed[][1] = {
    {"sjsnkzd76ocard4u.onion"}, //node1
    {"rs62fu3zc3cdpu7m.onion"}, //node2
	{"o2oephaupotv5nhb.onion"}, //temp node 3
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. tele is probably already running."), addrBind.ToString().c_str());
        else
